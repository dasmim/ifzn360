	...
	<head>
	  ...
	  <!-- Google Font -->
  		...
  		<script type="text/javascript">
			vr url="img/Refeitorio.jpg" view=360;
		</script>
		<script>
			...
			function onVrViewLoad() {
				var vrView = new VRView.Player('#vrview', {
					...
					image: 'https://i.imgur.com/5DZYEE5.jpg',
		...
		<div class="caixas">
			<div class="group">
            	...
            	<div class="information b_b" id="information_id"><img src="<?=base_url()?>assets/imgs/izinho.png" id="idizinho">
	                	<p class="texto">Este é o refeitório do campus localizado no bloco A </P>
            	</div>
        	</div>

        	<div>
        		<div >
			      <a href="blocoB"><img class="icon a" id="iconeLocal" style="display: none;left: 56%;top: 40%;" src="<?=base_url()?>assets/imgs/m-m.svg" id="pin_a"></a>
