	...
	<head>
		...
		<link href="<?=base_url()?>/assets/css/css2.mapa.css" rel="stylesheet">
  		...
  		<script type="text/javascript">
			vr url="img/biblioteca.jpg" view=360;
		</script>
		<script>
			window.addEventListener('load', onVrViewLoad)
			function onVrViewLoad() {
				var vrView = new VRView.Player('#vrview', {
					image: 'https://i.imgur.com/jwihd1P.jpg',
					is_stereo: false,
					width: '100%',
					height: '900px'
				});
		...
		<div class="caixas">
			<div class="group">
            	...
            	<div class="information b_b" id="information_id"><img src="<?=base_url()?>assets/imgs/izinho.png" id="idizinho">
	                	<p class="texto" >Esta é a biblioteca do campus nela esta presente todo o acervo de livros do campus  </P>
            	</div>
        	</div>
