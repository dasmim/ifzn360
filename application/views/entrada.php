	...
	<head>
	  ...
	  <!-- AdminLTE Skins. Choose a skin from the css/skins
  		...
  		<script type="text/javascript">
			vr url="img/entrada.jpg" view=360;
		</script>
		<script>
 ...
 -->		              				</ul>
		...
		<div class="caixas">
        	...
        	<div class="information b_b" id="information_id"><img src="<?=base_url()?>assets/imgs/izinho.png" id="idizinho">
	                <p class="texto">Esta é a entrada que dá acesso ao Hall de entrada</P>
            </div>

        	<div>
        		<div >
			      <a href="blocoB"><img class="icon a" id="iconeLocal" style="display: none;left: 55%;top: 77%;" src="<?=base_url()?>assets/imgs/m-m.svg" id="pin_a"></a>
