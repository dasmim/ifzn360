		...
		<script>
			...
			function onVrViewLoad() {
				var vrView = new VRView.Player('#vrview', {
					...
					image: 'https://i.imgur.com/8bs4I3W.jpg',
		...
		<div class="caixas">
			<div class="group">
            	...
            	<div class="information b_b" id="information_id"><img src="<?=base_url()?>assets/imgs/izinho.png" id="idizinho">
	                	<p class="texto">Este é o Bloco B que dá acesso a grande maioria das salas de aula, a Secretaria e ao Apoio Acadêmico </P>
            	</div>
        	</div>

        	<div>
        		<div >
			      <a href="blocoB"><img class="icon a" id="iconeLocal" style="display: none;left: 47%;top: 43%;" src="<?=base_url()?>assets/imgs/m-m.svg" id="pin_a"></a>
