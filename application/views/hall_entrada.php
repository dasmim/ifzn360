	...
	<head>
	  ...
	  <!-- Google Font -->
  		...
  		<script type="text/javascript">
			vr url="img/hall_entrada.jpg" view=360;
		</script>
		<script>
			...
			function onVrViewLoad() {
				var vrView = new VRView.Player('#vrview', {
					...
					image: 'https://i.imgur.com/iuUVD1O.jpg',
		...
		<div class="caixas">
			<div class="group">
	            ...
	            <div class="information b_b" id="information_id"><img src="<?=base_url()?>assets/imgs/izinho.png" id="idizinho">
	                	<p class="texto">Este é o Hall de entrada que da acesso ao auditorio e o Bloca A  </P>
            	</div>
        	</div>

        	<div>
        		<div >
			      <a href="blocoB"><img class="icon a" id="iconeLocal" style="left: 54%;top: 76%;display: none;" src="<?=base_url()?>assets/imgs/m-m.svg" id="pin_a"></a>
