	...
	<head>
		...
		<link href="<?=base_url()?>/assets/css/css2.mapa.css" rel="stylesheet">
  		...
  		<script type="text/javascript">
			vr url="img/fachada.jpg" view=360;
		</script>
		<script>
			...
			function onVrViewLoad() {
				var vrView = new VRView.Player('#vrview', {
					...
					image: 'https://i.imgur.com/5L1vFon.jpg',
		...
		<div class="caixas">
			<div class="group">
            	...
            	<div class="information b_b" id="information_id"><img src="<?=base_url()?>assets/imgs/izinho.png" id="idizinho">
	                	<p class="texto">Esta é a Fachada da instituição que dá acesso a entrada do campus </P>
            	</div>
        	</div>

        	<div>
        		<div >
			      <a href="blocoB"><img class="icon a" id="iconeLocal" style="display: none;left: 60%;top: 89%;" src="<?=base_url()?>assets/imgs/m-m.svg" id="pin_a"></a>
